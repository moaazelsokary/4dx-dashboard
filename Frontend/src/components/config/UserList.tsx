...
import { ROLE_DEPARTMENT_TOPIC_LABEL, isCmMealProjectRole, isCmMealManagerRole, isTopicLikeRole, normalizeUserRole } from '@/config/userRoles';
import {
...
function formatDeptOrTopicCell(row: AccountUser): string {
  if (isCmMealProjectRole(row.role) || isCmMealManagerRole(row.role)) {
